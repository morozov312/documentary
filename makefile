...
$(BIN_DIR)/documentary:  $(OBJ_DIR)/main.o  $(OBJ_DIR)/utilities.o  $(OBJ_DIR)comments_check.o $(OBJ_DIR)/comments_delete.o $(OBJ_DIR)/advance_check.o $(OBJ_DIR)/hadvance_handle.o $(OBJ_DIR)/processing.o
	gcc -Wall -Wextra  $(OBJ_DIR)/main.o  $(OBJ_DIR)/utilities.o  $(OBJ_DIR)/comments_check.o $(OBJ_DIR)/comments_delete.o $(OBJ_DIR)/advance_check.o $(OBJ_DIR)/advance_handle.o $(OBJ_DIR)/processing.o -o $(BIN_DIR)/documentary  $(FLAGS)
...
$(OBJ_DIR)/advance_check.o: $(SRC_DIR)/advance_check.c
	gcc -Wall -Wextra -c  $(SRC_DIR)/advance_check.c -o  $(OBJ_DIR)/advance_check.o  $(FLAGS)

$(OBJ_DIR)/advance_handle.o: $(SRC_DIR)/advance_handle.c
	gcc -Wall -Wextra -c  $(SRC_DIR)/advance_handle.c -o  $(OBJ_DIR)/advance_handle.o  $(FLAGS)

$(OBJ_DIR)/processing.o: $(SRC_DIR)/processing.c
	gcc -Wall -Wextra -c  $(SRC_DIR)/processing.c -o  $(OBJ_DIR)/processing.o  $(FLAGS)

$(BIN_DIR)/testing: $(OBJ_TEST_DIR)/main.o $(OBJ_TEST_DIR)/utilities_test.o $(OBJ_TEST_DIR)/comments_check_test.o $(OBJ_TEST_DIR)/comments_delete_test.o $(OBJ_TEST_DIR)/advance_check_test.o $(OBJ_TEST_DIR)/advance_handle_test.o $(OBJ_TEST_DIR)/processing_test.o $(OBJ_DIR)/utilities.o $(OBJ_DIR)/comments_check.o $(OBJ_DIR)/comments_delete.o $(OBJ_DIR)/advance_check.o $(OBJ_DIR)/advance_handle.o $(OBJ_DIR)/processing.o
	gcc $(OBJ_TEST_DIR)/main.o $(OBJ_TEST_DIR)/utilities_test.o $(OBJ_TEST_DIR)/comments_check_test.o $(OBJ_TEST_DIR)/comments_delete_test.o $(OBJ_TEST_DIR)/advance_check_test.o $(OBJ_TEST_DIR)/advance_handle_test.o $(OBJ_TEST_DIR)/processing_test.o $(OBJ_DIR)/utilities.o $(OBJ_DIR)/comments_check.o $(OBJ_DIR)/comments_delete.o $(OBJ_DIR)/advance_check.o $(OBJ_DIR)/advance_handle.o $(OBJ_DIR)/processing.o -o $(BIN_DIR)/testing  $(FLAG)
...
$(OBJ_TEST_DIR)/comments_delete_test.o: $(TEST_DIR)/comments_delete_test.c
	gcc -Wall -Wextra -I thirdparty -I src -c  $(TEST_DIR)/comments_delete.c -o  $(OBJ_TEST_DIR)/comments_delete.o  $(FLAG)

$(OBJ_TEST_DIR)/advance_check_test.o: $(TEST_DIR)/advance_check_test.c
	gcc -Wall -Wextra -I thirdparty -I src -c  $(TEST_DIR)/advance_check_test.c -o  $(OBJ_TEST_DIR)/advance_check_test.o  $(FLAG)

$(OBJ_TEST_DIR)/advance_handle_test.o: $(TEST_DIR)/advance_handle_test.c
	gcc -Wall -Wextra -I thirdparty -I src -c  $(TEST_DIR)/advance_handle_test.c -o  $(OBJ_TEST_DIR)/advance_handle_test.o  $(FLAG)
